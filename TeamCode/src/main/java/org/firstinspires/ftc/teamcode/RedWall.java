...
public class RedWall extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        //Grab block degres
        leftDriveMotor.setTargetPosition(-11617 - 9020);
        leftDriveMotor.setPower(1);

        while(rightDriveMotor.isBusy()){ }

        //Point turn
        leftDriveMotor.setTargetPosition(-22892 -9020);
        rightDriveMotor.setTargetPosition(642);
        leftDriveMotor.setPower(1);
        rightDriveMotor.setPower(1);

        //Drive foward
        leftDriveMotor.setTargetPosition(-27206 - 2672 - 9020);
        rightDriveMotor.setTargetPosition(4956 + 2672);
        leftDriveMotor.setPower(1);
        rightDriveMotor.setPower(1);
        ...
        //90 degree turn
        leftDriveMotor.setTargetPosition(-118636 - 2672 - 9020);
        rightDriveMotor.setTargetPosition(13526 + 2672);
        leftDriveMotor.setPower(1);
        rightDriveMotor.setPower(1);
        ...
        leftDriveMotor.setTargetPosition(-18636 - 8138 - 2672 - 9020);
        rightDriveMotor.setTargetPosition(13526 + 8138 + 2672);
        leftDriveMotor.setPower(1);
        rightDriveMotor.setPower(1);
        ...
        leftDriveMotor.setTargetPosition(-18636 - 8138 + 2713 - 2672 - 9020);
        rightDriveMotor.setTargetPosition(+13526 + 8138 - 2713 + 2672);
        leftDriveMotor.setPower(1);
        rightDriveMotor.setPower(1);
